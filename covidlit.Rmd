...
```{r}
covidlit <- read_csv('~/Documents/Nature/Programming/covidlit/covidlit-COVID-19_Portfolio-export_2020-06-03-22-46-14.csv')
```
...
Write to CSV
```{r}
f = file.path('~/tmp', paste0('Covidlit_counts-', format(Sys.Date(), "%Y%m%d.csv")))
write.table(df, f, sep=",",append=FALSE,quote=FALSE,col.names = TRUE, row.names = FALSE, eol="\r\n")
```
